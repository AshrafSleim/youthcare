...
if(isset($_POST['search'])){
    ...
    $css1=(string)$css2;
       ...
       $query1="SELECT `id`, `name`, `card_id`, `Faculty`, `level`, `phone`, `address` FROM `student` WHERE card_id = $css1";
        $res_1=mysqli_query($connection, $query1);
         if (mysqli_num_rows($res_1) > 0) {
             ...
             $query2 = "SELECT `register`.`result` , `fields`.`name` , `fields`.`date` FROM `student` , `fields` , `register` ,`student_field` WHERE register.student_field_id =student_field.id and student_field.student_id = student.id and student.id='$id1' and register.fields_id=fields.id and register.flag='1'";
    ...
    $required="required";
    redirect("serche_student.php");
    
}elseif(isset($_POST['update'])){
    $readonly=" ";
    $card_id2=$_POST['id2'];
     $query1="SELECT `id`, `name`, `card_id`, `Faculty`, `level`, `phone`, `address` FROM `student` WHERE card_id = $card_id2";
        $res_1=mysqli_query($connection, $query1);
         if (mysqli_num_rows($res_1) > 0) {
             $flagid=mysqli_fetch_assoc($res_1);
             $id1=$flagid['id'];
    ...
    $query5="UPDATE `student` SET `level`='$upd1',`phone`=$upd2,`address`='$upd3' WHERE card_id = $card_id2";
...
<body class="main">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
             ...
             <li class="nav-item dropdown ">
                      ...
                      <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              ...
                              <a class="dropdown-item active" href="serche_student.php">البحث عن بيانات طالب</a>
                          </div>     
                          </li>
                          <li class="nav-item ">
          ...
          <form class="form-inline my-2 my-lg-0" action="serche_student.php" method="post">
            
<button class="btn btn-info my-2 p-2 mr-sm-4 " type="submit" name="button1">تسجيل خروج </button>          </form>
        </div>
      </nav>
    ...
    <div class="container">
        ...
        <div class="tab-content form-content">
            <div class="tab-pane active  px-4 fade show" id="new-competition" role="tabpanel">
                ...
                <form action="serche_student.php" method="post" class="mb-3 pb-2">
                    <div class="form-row justify-content-center">
                        <div class="col-sm-4 mt-2 col-md-4 col-lg-2 ">
                            <label for="card_id" <?php echo $hidden2;?>> رقم بطاقه الطالب</label>
                              
                        </div>
                        <div class="col-sm-8 mt-2 col-md-8 col-lg-4 ">
                          <input type="number" placeholder="14 رقم" class="form-control" id="card_id" min="10000000000000" max="99999999999999" name="css"  <?php echo $required; ?> <?php echo $hidden2;?>>
                      </div>
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-row justify-content-center">
                                <div id="scroll" class="col-sm-12 col-md-12 col-lg-6 ">
                               
                        
                                        <table class="table table-info table-hover  table-striped mt-5  " style="table-layout:fixed">
                                                <thead class="bg-info">
                                                  <tr class="text-white" >
