...
if(isset($_POST['search']))
{
    ...
    $date1=$_POST['date'];
    $hidden=" ";
    $query1 = "SELECT `id` FROM `fields` WHERE date='$date1' and name='$faild1'";
    $res_1 = mysqli_query($connection, $query1);
    $flagid=mysqli_fetch_assoc($res_1);
    $x=$flagid['id'];
   
    $query2 = "SELECT `register`.`id` , `register`.`result` , `student`.`name` FROM `student` , `register` ,`student_field` WHERE register.student_field_id =student_field.id and student_field.student_id = student.id and register.fields_id='$x' and register.flag='1'";
...
<body class="main">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <form class="form-inline my-2 my-lg-0" action="result1.php" method="post">
    ...
    <div class="container">
        ...
        <div class="form-content">
            <div class="px-4 fade show" id="new-competition" role="tabpanel">
                ...
                <form action="result1.php" method="post" class="mb-3 pb-2">
