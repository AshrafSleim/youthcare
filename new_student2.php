          ...
          if(!empty($_POST["feild"])) {
            $query1="SELECT `id`FROM `student` WHERE card_id='$css'";
             ...
             if (mysqli_num_rows($res_1) > 0) {
                 ...
                 $x=$flagid['id'];
                 $query2="SELECT `student_id`,`flag` FROM `student_field` WHERE student_id='$x' and flag=2";
...
//                     $N = count($feild1);
                        ...
                        {
                           $query3="INSERT INTO `student_field`( `student_id`, `field_name`, `flag`) VALUES ($x,'$feild1',2)";
                 ...
                 $x=$flagid['id'];
                    // $N = count($feild1);
                        foreach($_POST["feild"] as $feild1)
                        {
                          ...
                          $query6="INSERT INTO `student_field`( `student_id`, `field_name`, `flag`) VALUES ($x,'$feild1',2)";
...
<body class="main">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown ">
                              ...
                              <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                      <a class="dropdown-item active" href="new_student2.php">تسجيل طالب </a>
                  ...
                  <form class="form-inline my-2 my-lg-0" action="new_student2.php" method="post">
    ...
    <div class="container">
            ...
            <div class="form-content">
               ...
               <form action="new_student2.php" method="post" class="mb-3 pb-2">
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 ">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="غناء">غناء
                              </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="عزف">عزف
                              </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="انشاد دينى">انشاد دينى
                              </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="فنون شعبيه">فنون شعبيه
                              </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="فنون تشكيليه">فنون تشكيليه
                              </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="feild[]" value="مسرح">مسرح
                              </label>
