...
if(isset($_POST['search'])){
   ...
   $ashraf=$_POST['field'];
    $data2=$_POST['date'];
    $type55=$_POST['type2'];
    $query1="SELECT `id`, `name`, `Activity_id`, `data`, `type`, `address`, `start_trining`, `end_trining`, `supervisors` FROM `fieldartist` WHERE name = '$ashraf' and data = '$data2' and type='$type55' ";
    ...
    $required="required";
    redirect("serche_activity2.php");
}elseif(isset($_POST['update'])){
    $readonly=" ";
    $id2=$_POST['id1'];
    $query1="SELECT `id`, `name`, `Activity_id`, `data`, `type`, `address`, `start_trining`, `end_trining`, `supervisors` FROM `fieldartist` WHERE id = '$id2' ";
        $res_1=mysqli_query($connection, $query1);
         if (mysqli_num_rows($res_1) > 0) {
             $flagid=mysqli_fetch_assoc($res_1);
             $id1=$flagid['id'];
    ...
    $upd5=$_POST['date4'];
    $id2=$_POST['id1'];
    $query5="UPDATE `fieldartist` SET `data`='$upd1',`address`='$upd2',`start_trining`='$upd4',`end_trining`='$upd5',`supervisors`='$upd3' WHERE id = '$id2'";
...
<body class="main">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  ...
                                  <a class="dropdown-item active" href="serche_activity2.php">البحث عن مسابقه</a>
                         </div>
                              </li>
                  ...
                  <form class="form-inline my-2 my-lg-0" action="serche_activity2.php" method="post">
    ...
    <div class="container">
            ...
            <div class="form-content">
                ...
                <form action="serche_activity2.php" method="post" class="mb-3 pb-2">
                   ...
                   <div class="form-row justify-content-center mt-2" <?php echo $hidden2;?> >
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 ">
                            <label <?php echo $hidden3;?>>لا يمكن التعديل على اسم النشاط و اسم المجال و نوع التنفيذ </label><br>
                            ...
                            <input type="text" class="form-control" id="activty" placeholder="النشاط" name="activty" value="<?php echo $Activity_name;?>" readonly>
                                ...
                                <div class="form-row justify-content-center">
                                        <div class="col-sm-6 mt-2 col-md-6 col-lg-3 ">
                                            ...
                                            <input type="text" class="form-control" id="supervision" placeholder="المجال" name="faild2" value="<?php echo $name;?>" readonly>
                                        </div>
                                        <div class="col-sm-6 mt-2 col-md-6 col-lg-3 ">
                                            <label for="date">التاريخ</label>
                                            <input type="date" placeholder="dd/mm/yyyy" class="form-control" id="date" name="date2" value="<?php echo  $date1;?>" <?php echo $readonly;?>>
                                        </div>
                                    </div>
                                    <div class="form-row justify-content-center">
                                        <div class="col-sm-6 mt-2 col-md-6 col-lg-3 ">
                                            <label for="excution-field">نوع التنفيذ</label>
                                            <input type="text" class="form-control" id="supervision" placeholder="النوع"  name="type" value="<?php echo $execution_type;?>" readonly>
