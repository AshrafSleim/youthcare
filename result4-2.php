...
<?php
   ...
   $query2 ="SELECT `id`, `name`, `Faculty` FROM `student` WHERE flag=1 and superTeam=1 ";
...
if(isset($_POST['save'])){
    ...
    $id3=$_POST['id1'];
     $query2 ="UPDATE `student` SET `superTeam`='0' WHERE id=$id3";
    
    
    $res_2 = mysqli_query($connection, $query2);

   
    $query3 ="SELECT `id`, `name`, `Faculty` FROM `student` WHERE flag=1 and superTeam=1 ";
...
<body class="main">
         ...
         <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <li class="nav-item dropdown ">
                      ...
                      <li class="nav-item dropdown active">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                      ...
                                      <a class="dropdown-item active" href="result4-2.php"> عرض منتخب الجامعه </a>
                                  </div>     
                                  </li>
                  ...
                  <form class="form-inline my-2 my-lg-0" action="result4-2.php" method="post">
    ...
    <div class="container">
        ...
        <div class="form-content">
            <div class="px-4 fade show" id="new-competition" role="tabpanel">
                ...
                <form action="result4-2.php" method="post" class="mb-3 pb-2">
                ...
                <tr>
                    ...
                    <td> <a href= "#" class="list-group-item list-group-item-action list-group-item-info text-center" onclick="document.getElementById('id01').style.display='block'" >حذف الطالب</a>  </td>
                </tr>
                <?php endwhile;?>
                        ...
                        <div class="col-sm-6 mt-2 col-md-6 col-lg-3 mt-5">
                            ...
                            <div class="mt-4 mx-4" >
                            <button class="btn btn-info mx-3 my-2" type="submit" name="save">حذف</button>
