       ...
       $query1="SELECT `id`, `name`, `card_id`, `Faculty`, `level`, `phone`, `address` FROM `student` WHERE card_id = $css1";
        $res_1=mysqli_query($connection, $query1);
         if (mysqli_num_rows($res_1) > 0) {
             ...
             $query2 = "SELECT `register`.`result` , `fieldartist`.`name` , `fieldartist`.`data` FROM `student` , `fieldartist` , `register` ,`student_field` WHERE register.student_field_id =student_field.id and student_field.student_id = student.id and student.id='$id1' and register.fieldArtist_id=fieldartist.id and register.flag='2'";
...
<body class="main">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-0 fixed-top" style="background:#00376d ; " >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <li class="nav-item dropdown ">
                              ...
                              <li class="nav-item dropdown active ">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                      ...
                                      <a class="dropdown-item active" href="serche_student2.php">البحث عن بيانات طالب</a>
                                  </div>
                                  </li>
                                  <li class="nav-item ">
                  ...
                  <form class="form-inline my-2 my-lg-0" action="serche_student2.php" method="post">
    ...
    <div class="container">
            ...
            <div class="form-content">
               ...
               <form action="serche_student2.php" method="post" class="mb-3 pb-2">
